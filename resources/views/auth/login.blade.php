        ...
        <div class="login-card w-full max-w-md bg-white rounded-2xl shadow-elegant p-8 md:p-10">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="email" name="email" type="email" required class="input-field pl-10 w-full py-2.5 rounded-lg focus:outline-none transition-colors bg-gray-50" placeholder="your@email.com">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="password" name="password" type="password" required class="input-field pl-10 w-full py-2.5 rounded-lg focus:outline-none transition-colors bg-gray-50" placeholder="••••••••">
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('register') }}" class="font-medium text-primary-600 hover:text-primary-700">Sign up</a>
                </p>
            </div>
        </div>
    </div>
